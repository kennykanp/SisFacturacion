<%@ Page Title="" Language="VB" MasterPageFile="~/PaginaMaestra02.master" AutoEventWireup="false" CodeFile="Categorias.aspx.vb" Inherits="Default3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <h1 style="text-align: center; font-family: 'Gill Sans MT Condensed'; font-size: 35px; background-color: #336699; color: #FFFFFF">Mantenimiento de Categorias-Productos (SQL SERVER)</h1>
<br />
    ...
    <tr>
        <td class="style14">
            Abreviatura</td>
        <td class="style3">
            <asp:TextBox ID="abreviatura" runat="server" MaxLength="50"></asp:TextBox>
        </td>
...
<h1 style="text-align: center; font-family: 'Gill Sans MT Condensed'; font-size: 35px; background-color: #336699; color: #FFFFFF">Busqueda de Categorias</h1>
<br />
    ...
    <table align="center" class="style5">
        ...
        <tr>
            <td class="style11">
                &nbsp;</td>
            <td class="style12">
                <asp:RadioButton ID="RadioButton2" runat="server" Text="Nombre Categoria" 
                    GroupName="opcion" />
            </td>
            <td class="style10">
                &nbsp;</td>
