<%@ Page Title="" Language="VB" MasterPageFile="~/PaginaMaestra02.master" AutoEventWireup="false" CodeFile="Productos.aspx.vb" Inherits="Default2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <h1 style="text-align: center; font-family: 'Gill Sans MT Condensed'; font-size: 35px; background-color: #336699; color: #FFFFFF">Mantenimiento de Productos (SQL SERVER)</h1>
<br />
    ...
    <tr>
        <td class="style14">
            Uni. Med:</td>
        <td class="style3">
            <asp:DropDownList ID="cbouniMedida" runat="server">
            </asp:DropDownList>
        </td>
    ...
    <tr>
        <td class="style14">
            Pre. Compra:</td>
        <td class="style3">
            <asp:TextBox ID="preCompra" runat="server" MaxLength="50"></asp:TextBox>
        </td>        
    </tr>
    <tr>
        <td class="style14">
            Pre. Venta:</td>
        <td class="style3">
            <asp:TextBox ID="preVenta" runat="server" MaxLength="50"></asp:TextBox>
...
<h1 style="text-align: center; font-family: 'Gill Sans MT Condensed'; font-size: 35px; background-color: #336699; color: #FFFFFF">Busqueda de Productos</h1>
<br />
